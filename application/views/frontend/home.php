...
<!-- Mirrored from p.w3layouts.com/demos_new/template_demo/04-01-2018/grocery_shoppy-demo_Free/709526329/web/ by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 31 Jan 2019 09:56:59 GMT -->
...
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
	...
	<!--//pop-up-box-->
	<!-- price range -->
	<link rel="stylesheet" type="text/css" href="<?php echo base_url()?>assets/frontend/css/jquery-ui1.css">
	<!-- fonts -->
...
<body>
								...
								<li class="dropdown">
									...
									<ul class="dropdown-menu multi-column columns-3">
										<div class="agile_inner_drop_nav_info">
											...
											<div class="col-sm-4 multi-gd-img">
												<img src="<?php echo base_url()?>img/nav.png" alt="">
											</div>
											<div class="clearfix"></div>
										</div>
									</ul>
	...
	<div id="myCarousel" class="carousel slide" data-ride="carousel">
		...
		<div class="carousel-inner" role="listbox">
			...
			<div class="item item4" style="background-image:url(<?php echo base_url()?>img/a2.jpg)">
				<div class="container">
					<div class="carousel-caption">
						<h3>Today
							<span>Discount</span>
				...
				<div class="deal-leftmk left-side">
					...
					<div class="special-sec1">
						<div class="col-xs-4 img-deals">
							<img src="<?php echo base_url()?>img/d2.jpg" alt="">
						</div>
					...
					<div class="special-sec1">
						<div class="col-xs-4 img-deals">
							<img src="<?php echo base_url()?>img/d1.jpg" alt="">
						</div>
						<div class="col-xs-8 img-deal1">
					...
					<div class="special-sec1">
						<div class="col-xs-4 img-deals">
							<img src="<?php echo base_url()?>img/d4.jpg" alt="">
						</div>
						<div class="col-xs-8 img-deal1">
							<h3>Tata Salt</h3>
					...
					<div class="special-sec1">
						<div class="col-xs-4 img-deals">
							<img src="<?php echo base_url()?>img/d5.jpg" alt="">
						</div>
						<div class="col-xs-8 img-deal1">
					...
					<div class="special-sec1">
						<div class="col-xs-4 img-deals">
							<img src="<?php echo base_url()?>img/d3.jpg" alt="">
						</div>
						<div class="col-xs-8 img-deal1">
				...
				<div class="wrapper">
					...
					<div class="product-sec1" >
						...
						<div class="col-md-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								<div class="men-thumb-item">
									<img src="<?php echo base_url()?>img/m1.jpg" alt="">
						...
						<div class="col-md-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								<div class="men-thumb-item">
									<img src="<?php echo base_url()?>img/m2.jpg" alt="">
									<div class="men-cart-pro">
										<div class="inner-men-cart-pro">
											<a href="single.html" class="link-product-add-cart">Quick View</a>
										</div>
						...
						<div class="col-md-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								<div class="men-thumb-item">
									<img src="<?php echo base_url()?>img/m3.jpg" alt="">
									<div class="men-cart-pro">
										<div class="inner-men-cart-pro">
											<a href="single.html" class="link-product-add-cart">Quick View</a>
										</div>
					...
					<div class="new_product">
						...
						<div class="col-xs-5 bg-right-nut">
							<img src="<?php echo base_url()?>img/nut1.png" alt="">
						</div>
						<div class="clearfix"></div>
					</div>
					<!-- //second section (nuts special) -->
					...
					<div class="product-sec1">
						...
						<div class="col-md-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								<div class="men-thumb-item">
									<img src="<?php echo base_url()?>img/mk4.jpg" alt="">
									<div class="men-cart-pro">
										<div class="inner-men-cart-pro">
											<a href="single.html" class="link-product-add-cart">Quick View</a>
										</div>
						...
						<div class="col-md-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								<div class="men-thumb-item">
									<img src="<?php echo base_url()?>img/mk5.jpg" alt="">
									<div class="men-cart-pro">
										<div class="inner-men-cart-pro">
											<a href="single.html" class="link-product-add-cart">Quick View</a>
										</div>
						...
						<div class="col-md-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								<div class="men-thumb-item">
									<img src="<?php echo base_url()?>img/mk6.jpg" alt="">
									<div class="men-cart-pro">
										<div class="inner-men-cart-pro">
											<a href="single.html" class="link-product-add-cart">Quick View</a>
										</div>
					...
					<div class="product-sec1">
						...
						<div class="col-md-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								<div class="men-thumb-item">
									<img src="<?php echo base_url()?>img/mk7.jpg" alt="">
									<div class="men-cart-pro">
										<div class="inner-men-cart-pro">
											<a href="single.html" class="link-product-add-cart">Quick View</a>
										</div>
						...
						<div class="col-md-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								<div class="men-thumb-item">
									<img src="<?php echo base_url()?>img/mk8.jpg" alt="">
									<div class="men-cart-pro">
										<div class="inner-men-cart-pro">
											<a href="single.html" class="link-product-add-cart">Quick View</a>
										</div>
						...
						<div class="col-md-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								<div class="men-thumb-item">
									<img src="<?php echo base_url()?>img/mk9.jpg" alt="">
									<div class="men-cart-pro">
										<div class="inner-men-cart-pro">
											<a href="single.html" class="link-product-add-cart">Quick View</a>
										</div>
				...
				<ul id="flexiselDemo1">
					<li>
						<div class="w3l-specilamk">
							<div class="speioffer-agile">
								<a href="single.html">
									<img src="<?php echo base_url()?>img/s1.jpg" alt="">
								</a>
							</div>
					...
					<li>
						<div class="w3l-specilamk">
							<div class="speioffer-agile">
								<a href="single.html">
									<img src="<?php echo base_url()?>img/s4.jpg" alt="">
								</a>
							</div>
							<div class="product-name-w3l">
								<h4>
					...
					<li>
						<div class="w3l-specilamk">
							<div class="speioffer-agile">
								<a href="single.html">
									<img src="<?php echo base_url()?>img/s2.jpg" alt="">
								</a>
							</div>
							<div class="product-name-w3l">
								<h4>
					...
					<li>
						<div class="w3l-specilamk">
							<div class="speioffer-agile">
								<a href="single2.html">
									<img src="<?php echo base_url()?>img/s3.jpg" alt="">
								</a>
							</div>
							<div class="product-name-w3l">
								<h4>
					...
					<li>
						<div class="w3l-specilamk">
							<div class="speioffer-agile">
								<a href="single.html">
									<img src="<?php echo base_url()?>img/s8.jpg" alt="">
								</a>
							</div>
							<div class="product-name-w3l">
								<h4>
					...
					<li>
						<div class="w3l-specilamk">
							<div class="speioffer-agile">
								<a href="single2.html">
									<img src="<?php echo base_url()?>img/s6.jpg" alt="">
								</a>
							</div>
							<div class="product-name-w3l">
								<h4>
					...
					<li>
						<div class="w3l-specilamk">
							<div class="speioffer-agile">
								<a href="single.html">
									<img src="<?php echo base_url()?>img/s5.jpg" alt="">
								</a>
							</div>
							<div class="product-name-w3l">
								<h4>
					...
					<li>
						<div class="w3l-specilamk">
							<div class="speioffer-agile">
								<a href="single2.html">
									<img src="<?php echo base_url()?>img/s9.jpg" alt="">
								</a>
							</div>
							<div class="product-name-w3l">
								<h4>
	...
	<div class="footer-top">
		<div class="container-fluid">
			...
			<div class="col-xs-4 w3l-rightmk">
				<img src="<?php echo base_url()?>img/tab3.png" alt=" ">
			</div>
			<div class="clearfix"></div>
		</div>
	</div>
		...
		<div class="container">
			...
			<div class="agile-sometext">
				...
				<div class="sub-some child-momu">
					...
					<ul>
						<li>
							<img src="<?php echo base_url()?>img/pay2.png" alt="">
						</li>
						<li>
							<img src="<?php echo base_url()?>img/pay5.png" alt="">
						</li>
						<li>
							<img src="<?php echo base_url()?>img/pay1.png" alt="">
						</li>
						<li>
							<img src="<?php echo base_url()?>img/pay4.png" alt="">
						</li>
						<li>
							<img src="<?php echo base_url()?>img/pay6.png" alt="">
						</li>
						<li>
							<img src="<?php echo base_url()?>img/pay3.png" alt="">
						</li>
						<li>
							<img src="<?php echo base_url()?>img/pay7.png" alt="">
						</li>
						<li>
							<img src="<?php echo base_url()?>img/pay8.png" alt="">
						</li>
						<li>
	...
	<!-- cart-js -->
	<script src="<?php echo base_url()?>assets/frontend/js/minicart.js"></script>
	<script>
	...
	<script src="<?php echo base_url()?>assets/frontend/js/move-top.js"></script>
	<script src="<?php echo base_url()?>assets/frontend/js/easing.js"></script>
	<script>
...
<!-- Mirrored from p.w3layouts.com/demos_new/template_demo/04-01-2018/grocery_shoppy-demo_Free/709526329/web/ by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 31 Jan 2019 09:58:35 GMT -->
</html>
