                          ...
                          <strong>Message!!!!</strong> <?php echo $error ; ?>
                                 ...
                                 <?php
                                  ...
                                  <div class="form-group">
                                    ...
                                    <input type="text" name="item_name" class="form-control" id="exampleInputEmail1"  required>
                                    <!-- <input type="hidden" name="default" value="1" class="form-control" id="exampleInputEmail1"> -->
                                  </div>

                                  <div class="form-group">
                                    <label for="exampleInputEmail1">Item Price</label>
                                    <input type="text" name="item_price" class="form-control" id="exampleInputEmail1"  required>
                                    <!-- <input type="hidden" name="default" value="1" class="form-control" id="exampleInputEmail1"> -->
                                  </div>
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                      <textarea class="form-control" name="item_summary" rows="5" required></textarea>
                                    </div>
                                  </div>
